...
export const companies: Company[] = [
  { id: 'ironveil-robotics', fund_id: 'fund-1', name: 'Ironveil Robotics', sector: 'Industrial Automation', description: 'Autonomous robotic systems for precision manufacturing and warehouse logistics.', status: 'active', total_invested: 4750000, current_mark: 15848000, entry_valuation: 12000000, current_valuation: 140000000, initial_investment_date: '2021-06-01', latest_investment_date: '2024-02-28', moic: 3.34, irr: 0.58 },
  { id: 'gridstone-energy', fund_id: 'fund-1', name: 'Gridstone Energy', sector: 'Energy Transition', description: 'Grid-scale battery storage and energy management software for utilities and industrials.', status: 'active', total_invested: 5500000, current_mark: 7005000, entry_valuation: 60000000, current_valuation: 150000000, initial_investment_date: '2022-03-15', latest_investment_date: '2023-09-20', moic: 1.27, irr: 0.31 },
  { id: 'luminos-ai', fund_id: 'fund-1', name: 'Luminos AI', sector: 'Applied AI', description: 'AI platform for predictive maintenance and process optimization in heavy industry.', status: 'active', total_invested: 3000000, current_mark: 4830000, entry_valuation: 15000000, current_valuation: 70000000, initial_investment_date: '2022-08-22', latest_investment_date: '2023-12-05', moic: 1.61, irr: 0.72 },
  { id: 'stratum-infra', fund_id: 'fund-1', name: 'Stratum Infrastructure', sector: 'Digital Infrastructure', description: 'Distributed edge compute and connectivity infrastructure for industrial IoT deployments.', status: 'active', total_invested: 3000000, current_mark: 3000000, entry_valuation: 80000000, current_valuation: 80000000, initial_investment_date: '2023-04-10', latest_investment_date: '2023-04-10', moic: 1.00, irr: 0.00 },
  { id: 'solara-power', fund_id: 'fund-1', name: 'Solara Power', sector: 'Energy Transition', description: 'Next-generation solar inverter technology enabling high-density, low-cost renewable deployment.', status: 'active', total_invested: 1500000, current_mark: 1500000, entry_valuation: 20000000, current_valuation: 20000000, initial_investment_date: '2023-07-14', latest_investment_date: '2023-07-14', moic: 1.00, irr: 0.00 },
]

export const investments: Record<string, Investment[]> = {
  'ironveil-robotics': [
    {
      id: 'inv-fr1', company_id: 'ironveil-robotics', round_name: 'Seed', date: '2021-06-01',
      ...
      current_mark: 8750000, realized_gain: 0, unrealized_gain: 8000000, moic: 11.67, irr: 0.89,
      co_investors: [
    ...
    {
      id: 'inv-fr2', company_id: 'ironveil-robotics', round_name: 'Series A', date: '2022-11-15',
      ...
      current_mark: 5096000, realized_gain: 0, unrealized_gain: 3096000, moic: 2.55, irr: 0.61,
      co_investors: [
    ...
    {
      id: 'inv-fr3', company_id: 'ironveil-robotics', round_name: 'Series B', date: '2024-02-28',
      ...
      current_mark: 2002000, realized_gain: 0, unrealized_gain: 2000, moic: 1.00, irr: 0.38,
      co_investors: [
  ...
  'gridstone-energy': [
    {
      id: 'inv-vs1', company_id: 'gridstone-energy', round_name: 'Series A', date: '2022-03-15',
      ...
      current_mark: 4500000, realized_gain: 0, unrealized_gain: 1500000, moic: 1.50, irr: 0.20, // repriced at Series B PPS $150
      co_investors: [
    ...
    {
      id: 'inv-vs2', company_id: 'gridstone-energy', round_name: 'Series B', date: '2023-09-20',
      ...
      current_mark: 2505000, realized_gain: 0, unrealized_gain: 5000, moic: 1.00, irr: 0.42, // latest round, at cost
      co_investors: [
  ...
  'luminos-ai': [
    {
      id: 'inv-ma1', company_id: 'luminos-ai', round_name: 'Seed', date: '2022-08-22',
      ...
      current_mark: 2331000, realized_gain: 0, unrealized_gain: 1831000, moic: 4.66, irr: 1.12, // repriced at Series A PPS $70
      co_investors: [
    ...
    {
      id: 'inv-ma2', company_id: 'luminos-ai', round_name: 'Series A', date: '2023-12-05',
      ...
      current_mark: 2499000, realized_gain: 0, unrealized_gain: -1000, moic: 1.00, irr: 0.68, // latest round, at cost
      co_investors: [
  ...
  'stratum-infra': [
    {
      id: 'inv-li1', company_id: 'stratum-infra', round_name: 'Series A', date: '2023-04-10',
  ...
  'solara-power': [
    {
      id: 'inv-hp1', company_id: 'solara-power', round_name: 'Seed', date: '2023-07-14',
