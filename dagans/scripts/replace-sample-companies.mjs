...
const investments = [
  ...
  // Lattice Infrastructure — 1 round
  {
...
const coInvestors = [
  // Forge Robotics
  { id: 'ci-fr1a', investment_id: 'inv-fr1', name: 'Lux Capital', amount: 1500000, ownership_pct: 12.50 },
  { id: 'ci-fr1b', investment_id: 'inv-fr1', name: 'Founders Fund', amount: 1000000, ownership_pct: 8.33 },
  { id: 'ci-fr2a', investment_id: 'inv-fr2', name: 'Andreessen Horowitz', amount: 8000000, ownership_pct: 14.55 },
  { id: 'ci-fr2b', investment_id: 'inv-fr2', name: 'Khosla Ventures', amount: 5000000, ownership_pct: 9.09 },
  { id: 'ci-fr3a', investment_id: 'inv-fr3', name: 'Tiger Global', amount: 20000000, ownership_pct: 14.29 },
  { id: 'ci-fr3b', investment_id: 'inv-fr3', name: 'General Catalyst', amount: 15000000, ownership_pct: 10.71 },

  // Voltaic Systems
  { id: 'ci-vs1a', investment_id: 'inv-vs1', name: 'Breakthrough Energy', amount: 10000000, ownership_pct: 16.67 },
  { id: 'ci-vs1b', investment_id: 'inv-vs1', name: 'Energy Impact Partners', amount: 8000000, ownership_pct: 13.33 },
  { id: 'ci-vs2a', investment_id: 'inv-vs2', name: 'Prelude Ventures', amount: 25000000, ownership_pct: 16.67 },
  { id: 'ci-vs2b', investment_id: 'inv-vs2', name: 'Temasek', amount: 20000000, ownership_pct: 13.33 },

  // Meridian AI
  { id: 'ci-ma1a', investment_id: 'inv-ma1', name: 'Y Combinator', amount: 500000, ownership_pct: 3.33 },
  { id: 'ci-ma1b', investment_id: 'inv-ma1', name: 'Pear VC', amount: 1000000, ownership_pct: 6.67 },
  { id: 'ci-ma2a', investment_id: 'inv-ma2', name: 'Sequoia Capital', amount: 10000000, ownership_pct: 14.29 },
  { id: 'ci-ma2b', investment_id: 'inv-ma2', name: 'Coatue', amount: 5000000, ownership_pct: 7.14 },

  // Lattice Infrastructure
  { id: 'ci-li1a', investment_id: 'inv-li1', name: 'Bessemer Venture Partners', amount: 15000000, ownership_pct: 18.75 },
  { id: 'ci-li1b', investment_id: 'inv-li1', name: 'Insight Partners', amount: 12000000, ownership_pct: 15.00 },

  // Helios Power
  { id: 'ci-hp1a', investment_id: 'inv-hp1', name: 'Congruent Ventures', amount: 1500000, ownership_pct: 7.50 },
  { id: 'ci-hp1b', investment_id: 'inv-hp1', name: 'Powerhouse Ventures', amount: 1000000, ownership_pct: 5.00 },
]

async function run() {
  const oldIds = ['nexus-ai', 'helix-bio', 'volt-energy', 'cipher-sec', 'bloom-co']
  const newIds = companies.map(c => c.id)

  console.log('🗑  Removing old co_investors...')
  const oldInvIds = ['inv-n1','inv-n2','inv-n3','inv-h1','inv-v1','inv-v2','inv-c1','inv-b1']
